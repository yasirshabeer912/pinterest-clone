...
const MobileWelcom = () => {
  ...
  return (
    <div>
      ...
      <div className="container-fluid mobileWelcomPage bg-warning d-flex flex-column gap-4 justify-content-center align-items-center d-block d-md-none">
        ...
        <h1 className="h1 fw-bold text-white text-center display-2">Welcom To <br /> Pinterest</h1>
        <div className="btns w-100">
          <ContinueWithGoogle />

        </div>
        <div className="btns w-100">
          <div className="btn LoginBtn w-100 py-3" onClick={() => setShowW(true)}>
            Signup to Pinterest
          </div>
        </div>
      </div>
      <Signup showW={showW} setShowW={setShowW} />
    </div>
  )
}
