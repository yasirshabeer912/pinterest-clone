                ...
                <div className="container-fluid fixed-top header__">
                    ...
                    <div className="right d-flex gap-4 align-items-center">
                        ...
                        <div className="btns d-flex gap-2">
                            <div className="btn LoginBtn" data-bs-toggle="modal" data-bs-target="#exampleModal">Login</div>
                            <div className="btn SignUpBtn" data-bs-toggle="modal" data-bs-target="#SignUpModel">Sign Up</div>
                        </div>
                    </div>
                </div>
                </div>
